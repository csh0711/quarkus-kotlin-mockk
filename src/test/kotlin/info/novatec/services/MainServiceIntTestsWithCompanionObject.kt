 ...
 */
@QuarkusTest
@TestProfile(MainServiceIntTestsWithCompanionObjectProfile::class) //Only needed as MainServiceTest exists several times
class MainServiceIntTestsWithCompanionObject {
 ...
 */
class MainServiceIntTestsWithCompanionObjectProfile : QuarkusTestProfile
